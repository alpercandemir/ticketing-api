...
public class User {
    ...
    public static class Builder {
        ...
        public Builder passwordHash(String passwordHash) { user.setPasswordHash(passwordHash); return this; }
        public Builder roles(String roles) { user.setRoles(roles); return this; }
